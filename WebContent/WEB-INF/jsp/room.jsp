...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
   ...
   We Are Happy To Help You to find out Rooms !!! 
  </div>
</div>
...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:43px;" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="/welcome.jsp">Home</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="http://localhost:8081/JobNotifiy/service/getNotifiy/job">Job Search</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="http://localhost:8081/JobNotifiy/service/roomies/room">Room Search</a>
 </nav>
            ...
            app.controller("CountryController", function($scope, $http) {
                ...
                $scope.submitCountry = function() {
                    ...
                    if ($scope.countryForm.id == -1) {
                        ...
                        method = "POST";
                        url = 'http://localhost:8081/JobNotifiy/service/roomies/';
                    } else {
    ...
    <body ng-app="CountryManagement" ng-controller="CountryController">
        ...
        <form ng-submit="submitCountry()">
            <table>
                ...
                <tr>
                    <td>Job Details</td>
                    <td><input type="text" ng-model="countryForm.description"  /></td>
                </tr>
                <tr>
